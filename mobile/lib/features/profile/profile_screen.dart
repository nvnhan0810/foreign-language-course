          ...
          SliverList(
            delegate: SliverChildBuilderDelegate(
              (context, index) {
                ...
                return _HistoryTile(item: item, dateFormat: dateFormat);
              },
...
class _HistoryTile extends StatelessWidget {
  const _HistoryTile({required this.item, required this.dateFormat});
  ...
  @override
  Widget build(BuildContext context) {
    final dateLabel = item.completedAt != null
        ? dateFormat.format(item.completedAt!.toLocal())
        : '';
