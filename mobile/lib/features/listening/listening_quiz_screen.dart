...
class _ListeningQuizScreenState extends ConsumerState<ListeningQuizScreen> {
  ...
  Future<void> _load() async {
    try {
      final data = await ref.read(flcApiProvider).getAssessmentQuestions(widget.assessmentId);
      ...
      return Scaffold(
        ...
        body: Padding(
          ...
          child: Column(
            ...
            children: [
              Text(
                '${_result!.score}/${_result!.total} (${_result!.percentage}%)',
                style: Theme.of(context).textTheme.headlineMedium,
              ),
              Text(_result!.passed ? 'Đạt' : 'Chưa đạt',
                  style: TextStyle(
                  ...
                  children: _result!.results.map((r) {
                    ...
                    return Card(
                      child: ListTile(
                        ...
                        trailing: Icon(ok ? Icons.check : Icons.close,
